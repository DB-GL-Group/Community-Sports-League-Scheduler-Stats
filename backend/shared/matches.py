...
async def add_match(
    ...
    async with pool.connection() as conn, conn.cursor() as cur:
        await cur.execute(
            ...
            RETURNING id, division, slot_id, home_team_id, away_team_id, main_referee_id,
                      status, home_score, away_score, notes
            """,
            (
                division,
        ...
        return {
            ...
            "slot_id": match_row[2],
            "home_team_id": match_row[3],
            "away_team_id": match_row[4],
            "main_referee_id": match_row[5],
            "status": match_row[6],
            "home_score": match_row[7],
            "away_score": match_row[8],
            "notes": match_row[9],
        }
